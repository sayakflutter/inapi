            ...
            InkWell(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Poll',
                    style: rightBarTopTextStyle.copyWith(color: Colors.white),
                  ),
            ...
            if (polls.isEmpty) {
              return Expanded(
                child: Center(
                    child: Text(
                  'No polls available.',
                  style: rightBarTopTextStyle.copyWith(color: Colors.grey[600]),
                )),
              );
            }
              ...
              if (topics.isEmpty) {
                return Expanded(
                  child: Center(
                    ...
                    'No topics available.',
                    style:
                        rightBarTopTextStyle.copyWith(color: Colors.grey[600]),
                  )),
                );
              }
              return Expanded(
